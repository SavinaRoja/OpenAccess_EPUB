# -*- coding: utf-8 -*-
"""
openaccess_epub.article module defines abstract article representation

The openaccess_epub.article contains the :class:`Article` which is instantiated
per article XML file. Basic article structural elements are collected, metadata
analyzed and parsed according to DTD rules into a python data structure. The
Article class forms a basic unit in the procedure of analyzing articles and in
